      ...
      <div className="bg-white rounded-2xl p-6 shadow-xs border border-gray-200/80">
        ...
        <form onSubmit={handleSearchSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {/* Search input */}
            <div>
              <label htmlFor={searchInputId} className="block text-xs font-semibold text-gray-700 mb-1">
                Search Roll or Name
              </label>
              <input
                id={searchInputId}
            ...
            {/* Program Filter */}
            <div>
              <label htmlFor={programSelectId} className="block text-xs font-semibold text-gray-700 mb-1">
                Academic Program
              </label>
              <select
                id={programSelectId}
            ...
            {/* Batch input */}
            <div>
              <label htmlFor={batchInputId} className="block text-xs font-semibold text-gray-700 mb-1">
                Batch
              </label>
              <input
                id={batchInputId}
            ...
            {/* Semester input */}
            <div>
              <label htmlFor={semesterInputId} className="block text-xs font-semibold text-gray-700 mb-1">
                Semester
              </label>
              <input
                id={semesterInputId}
